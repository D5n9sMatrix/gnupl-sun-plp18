...
# load cube function
load "/home/denis/Workspace/gnupl-sun/matrix/bin/data/cubic_function/cubic1.fct"
...
CMD = ''
stats "/home/denis/Workspace/gnupl-sun/matrix/bin/data/data3.txt" u 1:(CMD = CMD.add_cube($1,$2,$3,$4)) nooutput
set xrange [0:13.6]
set yrange [0:11.8]
set zrange [0:13]
